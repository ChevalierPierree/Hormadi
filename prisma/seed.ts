...
async function main() {
  ...
  const products = [
    { slug: 'maillot-domicile-2025-2026', name: 'Maillot Domicile 2025-2026', description: 'Maillot officiel de l\'Hormadi pour la saison 2025-2026, porté par les joueurs à la Patinoire de la Barre. Design bleu et rouge aux couleurs du club.', price: 8900, category: 'maillots', sizes: '["S","M","L","XL","XXL"]', stock: 150, featured: true, imageUrl: '/images/boutique/maillot-domicile.svg' },
    { slug: 'maillot-exterieur-2025-2026', name: 'Maillot Extérieur 2025-2026', description: 'Maillot extérieur blanc avec accents bleu et rouge. Technologie respirante pour un confort optimal.', price: 8900, category: 'maillots', sizes: '["S","M","L","XL","XXL"]', stock: 120, featured: true, imageUrl: '/images/boutique/maillot-exterieur.svg' },
    { slug: 'maillot-collector-pays-basque', name: 'Maillot Collector "Pays Basque"', description: 'Édition limitée à 500 exemplaires. Maillot aux couleurs du Pays Basque avec motifs traditionnels. Numéroté et certifié.', price: 12900, category: 'collectors', sizes: '["S","M","L","XL"]', stock: 45, featured: true, imageUrl: '/images/boutique/maillot-collector.svg' },
    { slug: 'sweat-capuche-hormadi', name: 'Sweat à Capuche Hormadi', description: 'Sweat à capuche 100% coton avec logo brodé. Coupe moderne et confortable.', price: 5900, category: 'textile', sizes: '["S","M","L","XL","XXL"]', stock: 200, imageUrl: '/images/boutique/sweat-capuche-hormadi.jpg' },
    { slug: 'tshirt-hormadi-bleu', name: 'T-Shirt Hormadi Bleu', description: 'T-shirt officiel bleu marine avec logo imprimé. Coupe ajustée.', price: 2900, category: 'textile', sizes: '["S","M","L","XL","XXL"]', stock: 300, imageUrl: '/images/boutique/tshirt-hormadi-real.jpg' },
    { slug: 'casquette-hormadi', name: 'Casquette Hormadi', description: 'Casquette snapback avec logo brodé. Taille unique ajustable.', price: 2500, category: 'accessoires', stock: 180, imageUrl: '/images/boutique/casquette-real.jpg' },
    { slug: 'echarpe-hormadi', name: 'Écharpe Hormadi', description: 'Écharpe supporters en maille jacquard aux couleurs du club. 150cm de long.', price: 1900, category: 'accessoires', stock: 250, imageUrl: '/images/boutique/echarpe.svg' },
    { slug: 'bonnet-hormadi', name: 'Bonnet Hormadi', description: 'Bonnet tricoté avec pompon et logo brodé. Parfait pour les soirs de match.', price: 2200, category: 'accessoires', stock: 200, imageUrl: '/images/boutique/bonnet-real.jpg' },
    { slug: 'mug-hormadi', name: 'Mug Hormadi 350ml', description: 'Mug en céramique avec logo Hormadi. Passe au lave-vaisselle.', price: 1200, category: 'accessoires', stock: 400, imageUrl: '/images/boutique/mug.svg' },
    { slug: 'maillot-enfant-domicile', name: 'Maillot Enfant Domicile', description: 'Maillot domicile taille enfant. Réplique identique au maillot des pros.', price: 5900, category: 'enfant', sizes: '["6-8ans","8-10ans","10-12ans","12-14ans"]', stock: 100, imageUrl: '/images/boutique/maillot-enfant.svg' },
    { slug: 'tshirt-enfant-hormadi', name: 'T-Shirt Enfant Hormadi', description: 'T-shirt enfant avec mascottes et logo du club. 100% coton bio.', price: 1900, category: 'enfant', sizes: '["4-6ans","6-8ans","8-10ans","10-12ans"]', stock: 150, imageUrl: '/images/boutique/tshirt-enfant.svg' },
    ...
    { slug: 'porte-cles-hormadi', name: 'Porte-clés Logo Hormadi', description: 'Porte-clés en métal émaillé avec logo Hormadi. Finition premium.', price: 800, category: 'accessoires', stock: 500, imageUrl: '/images/boutique/porte-cles-real.jpg' },
    { slug: 'drapeau-hormadi-150x90', name: 'Drapeau Hormadi 150x90cm', description: 'Grand drapeau Hormadi aux couleurs du club. Parfait pour les matchs et la décoration.', price: 2500, category: 'accessoires', stock: 100, imageUrl: '/images/boutique/drapeau.svg' },
    { slug: 'polo-hormadi-classique', name: 'Polo Hormadi Classique', description: 'Polo élégant avec logo brodé sur la poitrine. Coupe regular. Disponible en bleu marine.', price: 4500, category: 'textile', sizes: '["S","M","L","XL","XXL"]', stock: 80, imageUrl: '/images/boutique/polo-real.jpg' },
  ]
